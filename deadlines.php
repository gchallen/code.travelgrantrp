...
echo "<p>The following deadlines determine when various conference grant
submission and review functions can be accessed.
<em>Deadline enforcement is automatically controlled by
the conference grant review software.</em>
Each time is specified in the timezone of the server
for this conference grant, which is shown at the top
of each page.";
...
if ($sub_reg && $sub_update != $sub_reg) {
    echo "<tr><td class='rcaption nowrap'>Application registration deadline</td>";
    ...
    echo "<td>You can register new applications until this deadline.</td></tr>\n";
}

if ($sub_update && $sub_sub != $sub_update) {
    echo "<tr><td class='rcaption nowrap'>Application update deadline</td>";
    ...
    echo "<td>You can upload new versions of your application and change other application information until this deadline.</td></tr>\n";
}

if ($sub_sub) {
    echo "<tr><td class='rcaption nowrap'>Application submission deadline</td>";
    ...
    echo "<td>You can submit registered applications until this deadline.  Only submitted applications will be reviewed.</td></tr>\n";
}
